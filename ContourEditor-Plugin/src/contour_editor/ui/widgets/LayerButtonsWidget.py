...
class LayerButtonsWidget(QWidget):
    def __init__(self, layer_name, layer_item, on_visibility_toggle, on_add_segment, on_lock_toggle, is_locked=False):
        ...
        self.visibility_btn.setIcon(icon_provider.get_icon('hide'))
        ...
        self.add_segment_btn.setIcon(icon_provider.get_icon('PLUS_BUTTON'))
        ...
        self.lock_btn.setIcon(icon_provider.get_icon('locked' if is_locked else 'unlocked'))
    ...
    def _handle_visibility_toggle(self):
        ...
        self.visibility_btn.setIcon(QIcon('hide' if visible else 'show'))
    ...
    def _handle_lock_toggle(self):
        ...
        self.lock_btn.setIcon(icon_provider.get_icon('locked' if locked else 'unlocked'))
