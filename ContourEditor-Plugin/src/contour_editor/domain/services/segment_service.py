...
class SegmentService:
    ...
    def set_layer_visibility(self, layer_name, visible):
        print(f"[SegmentService] Set {layer_name} visibility to {visible}")
        ...
        if layer is None:
            print(f"[SegmentService] Invalid layer: {layer_name}")
            return
    ...
    def set_layer_locked(self, layer_name, locked):
        print(f"[SegmentService] Set {layer_name} locked = {locked}")
