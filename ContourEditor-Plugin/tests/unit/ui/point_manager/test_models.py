...
def test_list_item_data_layer():
    ...
    from contour_editor.ui.point_manager.models import ListItemData
...
def test_list_item_data_repr_layer():
    ...
    from contour_editor.ui.point_manager.models import ListItemData
    item = ListItemData(item_type='layer', layer_name='Main')
    assert repr(item) == "ListItemData(layer=Main)"
