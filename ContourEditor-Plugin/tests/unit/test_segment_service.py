...
def test_set_layer_visibility_workpiece(segment_service, mock_manager):
    """Test set_layer_visibility for Workpiece layer."""
    mock_layer = Mock()
    mock_layer.name = "Workpiece"
    mock_manager.external_layer = mock_layer
    seg1 = Mock()
    seg1.layer = Mock(name="Workpiece")
    seg1.layer.name = "Workpiece"
    seg2 = Mock()
    ...
    segment_service.set_layer_visibility("Workpiece", False)
