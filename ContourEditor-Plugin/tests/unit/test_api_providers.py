...
- WorkpieceFormProvider (singleton pattern, form factory)
"""
import pytest
...
class TestDialogProvider:
    ...
    def setup_method(self):
        ...
        from contour_editor.api.providers import DialogProvider
    ...
    @patch('contour_editor.api.providers.dialog_provider.QMessageBox')
    ...
    def test_reset_to_default_provider(self):
        ...
        from contour_editor.api.providers import DialogProvider, DefaultDialogProvider
...
class TestWidgetProvider:
    ...
    def setup_method(self):
        ...
        from contour_editor.api.providers import WidgetProvider
    ...
    def test_reset_to_default_factory(self):
        ...
        from contour_editor.api.providers import WidgetProvider, DefaultWidgetFactory
...
class TestIconProvider:
    ...
    def setup_method(self):
        ...
        from contour_editor.api.providers import IconProvider
    ...
    def test_reset_to_default_provider(self):
        """Test resetting to default provider"""
        from contour_editor.api.providers import IconProvider, DefaultIconProvider
    ...
    def test_default_icon_provider_creates_valid_path(self):
        ...
        from contour_editor.api.providers import DefaultIconProvider
...
class TestWorkpieceFormProvider:
    """Tests for WorkpieceFormProvider singleton"""

    def setup_method(self):
        """Reset WorkpieceFormProvider before each test"""
        from contour_editor.api.providers import WorkpieceFormProvider
        WorkpieceFormProvider._instance = None
        WorkpieceFormProvider._factory = None

    def test_form_provider_singleton(self):
        """Test that WorkpieceFormProvider follows singleton pattern"""
        from contour_editor.api.providers import WorkpieceFormProvider

        provider1 = WorkpieceFormProvider.get()
        provider2 = WorkpieceFormProvider.get()
    ...
    def test_has_factory_returns_false_initially(self):
        ...
        provider = WorkpieceFormProvider.get()
...
class TestProviderIntegration:
    ...
    def setup_method(self):
        ...
        from contour_editor.api.providers import (
    ...
    def test_multiple_providers_are_independent_singletons(self):
        ...
        form_provider = WorkpieceFormProvider.get()
        ...
        assert form_provider is WorkpieceFormProvider.get()
